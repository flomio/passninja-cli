...
var TestHandler = /** @class */ (function () {
    ...
    TestHandler = __decorate([
        ...
        __param(0, injection_js_1.Inject(injection_js_1.forwardRef(function () { return socket_server_service_1.SocketServerService; }))),
        __metadata(\"design:paramtypes\", [socket_server_service_1.SocketServerService])
    ], TestHandler);
    return TestHandler;
}());
...
//# sourceURL=webpack://commonjs/./src/http-handlers/test-handler.ts?"