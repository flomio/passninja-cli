...
var LatestPassHandler = /** @class */ (function () {
    ...
    LatestPassHandler = __decorate([
        injection_js_1.Injectable(),
        __metadata(\"design:paramtypes\", [store_1.StateStoreService])
    ], LatestPassHandler);
    return LatestPassHandler;
}());
exports.LatestPassHandler = LatestPassHandler;


//# sourceURL=webpack://commonjs/./src/http-handlers/latest-pass.ts?"