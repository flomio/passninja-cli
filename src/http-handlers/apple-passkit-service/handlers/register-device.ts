...
var RegisterDeviceHandler = /** @class */ (function () {
    function RegisterDeviceHandler(service) {
     ...
     */
    RegisterDeviceHandler.prototype.handle = function (args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logging_1.dbg('register device', all, req.url);
                        return [4 /*yield*/, this.service.registerDevice(all)];
                    case 1:
                        _a.sent();
                        res.status(200);
                        res.send(null);
    ...
    RegisterDeviceHandler.path = '/:version' +
        '/devices/' +
        ':deviceLibraryIdentifier' +
        '/registrations/' +
        ':passTypeIdentifier/:serialNumber';
    RegisterDeviceHandler = __decorate([
...
//# sourceURL=webpack://commonjs/./src/http-handlers/apple-passkit-service/handlers/register-device.ts?"