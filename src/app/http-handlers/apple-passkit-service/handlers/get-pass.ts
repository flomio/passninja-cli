...
var GetPassHandler = /** @class */ (function () {
    function GetPassHandler(store, service) {
        this.store = store;
     ...
     */
    GetPassHandler.prototype.handle = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, params, pass;
            return __generator(this, function (_a) {
                req = args.req, res = args.res;
                params = req.params;
                pass = this.store.findPass(params).pass;
                if (pass) {
                    res.header('Content-Type', 'application/vnd.pkpass');
                    res.header('Last-Modified', pass.lastModified);
                    return [2 /*return*/, pass.buffer];
                }
                else {
    ...
    GetPassHandler.path = '/:version/passes/:passTypeIdentifier/:serialNumber';
    GetPassHandler = __decorate([
        injection_js_1.Injectable(),
        __metadata(\"design:paramtypes\", [store_1.StateStoreService,
            passkit_web_protocol_service_1.PasskitWebProtocolService])
    ], GetPassHandler);
    return GetPassHandler;
}());
exports.GetPassHandler = GetPassHandler;


//# sourceURL=webpack://commonjs/./src/http-handlers/apple-passkit-service/handlers/get-pass.ts?"