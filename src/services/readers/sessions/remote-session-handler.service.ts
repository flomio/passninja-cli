...
var RemoteSessionHandlerService = /** @class */ (function (_super) {
    __extends(RemoteSessionHandlerService, _super);
    function RemoteSessionHandlerService(options) {
        var _this = _super.call(this) || this;
        _this.options = options;
        return _this;
    }
    RemoteSessionHandlerService.prototype.handleMessage = function (body) {
    ...
    ], RemoteSessionHandlerService);
    return RemoteSessionHandlerService;
}(abstract_session_handler_service_1.SessionHandlerService));
exports.RemoteSessionHandlerService = RemoteSessionHandlerService;


//# sourceURL=webpack://commonjs/./src/services/readers/sessions/remote-session-handler.service.ts?"