...
var RemoteManifestSigner = /** @class */ (function (_super) {
    __extends(RemoteManifestSigner, _super);
    function RemoteManifestSigner(options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        resp = _a.sent();
                        obj = JSON.parse(resp);
                        return [2 /*return*/, Buffer.from(obj.signature, 'base64')];
                }
            });
        });
    };
    RemoteManifestSigner = __decorate([
        injection_js_1.Injectable(),
        __param(0, injection_js_1.Inject(injection_tokens_1.CONFIG_TOKEN)),
        __metadata(\"design:paramtypes\", [Object])
    ], RemoteManifestSigner);
    return RemoteManifestSigner;
}(manifest_signer_service_1.ManifestSignerService));
exports.RemoteManifestSigner = RemoteManifestSigner;


//# sourceURL=webpack://commonjs/./src/services/signing/remote-manifest-signer.service.ts?"