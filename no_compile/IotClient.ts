...
export class IotClient {
  ...
  constructor(private config: Configuration, private auth: AuthorizationService, createNewClient = false) {
  ...
  private initClient() {
    ...
    this.client = new DeviceSdk.device({
      ...
      clientId: this.config.clientId || 'very-bad-clientId-for-testing',
