export const nfcKeys = {
  ...
  google: {
    ...
    version: 1,
    privateKeyPem:
      '-----BEGIN EC PRIVATE KEY-----\nMHcCAQEEIC96RWF1FhFlgpCChY6rrULQspz6s7Uzvck54/3+lQcnoAoGCCqGSM49\nAwEHoUQDQgAEjMwTR/8dAzHZoRfPjcWTQXLeaLHWF+0tHGpkA4OGtn1+uvfzxVoC\nxN8Zd6bnM5lqKh/FDDt0tRkaFQguJ4DCwQ==\n-----END EC PRIVATE KEY-----'
  }
};
